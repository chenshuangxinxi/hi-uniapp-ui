...
<template>
    <view class="page-view">
        <view class="components">
            <view class="component" v-for="item in classifyCpmponents" :key="item.name" @tap="handleComponentClick(item)">
...
<script setup>
    ...
    // 商品列表
    const classifyCpmponents = ref([{ title: "紫菀 - aster", icon: "/static/images/icons/classify.png", path: "/subPackages/classify/pages/aster" }]);
