    ...
    <view class="page-view">
        ...
        <view class="demo-module">
            ...
            <view class="demo-module__content">
                <hi-button @tap="show1 = true" text="基础使用"></hi-button>
            </view>
        </view>
        ...
        <hi-popup :show="show1" title="标题" @close="show1 = false" maskClickable>
            <view class="content">
        ...
        <hi-popup :show="show3" :mode="mode" title="标题" @close="show3 = false">
            <view class="content">
                <view class="content-title">将进酒·君不见</view>
                <view>君不见，黄河之水天上来，奔流到海不复回。</view>
                <view>君不见，高堂明镜悲白发，朝如青丝暮成雪。</view>
